// Code By Utsav Patel - Assignment-3
...
class Smoothie {
    ...
    getDescription() {
        return `<h3><b>Order Summary</b></h3>Your smoothie with ${this.base}, ${this.fruits.join(', ')}, ${this.addOns.join(', ')} in size ${this.size} with sweetness level ${this.sweetness} is ready!`;
    }
}
